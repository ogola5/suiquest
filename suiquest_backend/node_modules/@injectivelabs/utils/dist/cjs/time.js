...
exports.SECONDS_IN_A_DAY = new index_js_1.BigNumber(60 * 60 * 24);
const convertTimestampToMilliseconds = (timestamp) => {
    const timestampInBigNumber = new index_js_1.BigNumberInBase(timestamp);
    if (timestamp.toString().length > 13) {
        return timestampInBigNumber
            .precision(13, index_js_1.BigNumber.ROUND_HALF_UP)
            .toNumber();
    }
    if (timestamp.toString().length < 13) {
...
const tomorrow = () => new index_js_1.BigNumberInBase(Math.floor(new Date().valueOf() / 1000) + 3600 * 24);
exports.tomorrow = tomorrow;
const todayInSeconds = () => Math.floor(Date.now() / 1000);
exports.todayInSeconds = todayInSeconds;
const past24Hours = () => new index_js_1.BigNumberInBase((0, exports.todayInSeconds)()).minus(exports.SECONDS_IN_A_DAY).toNumber();
exports.past24Hours = past24Hours;
const pastDays = (day = 1) => new index_js_1.BigNumberInBase((0, exports.todayInSeconds)())
