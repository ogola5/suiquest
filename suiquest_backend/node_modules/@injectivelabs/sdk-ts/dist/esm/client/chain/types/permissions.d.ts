import type { InjectivePermissionsV1Beta1Params, InjectivePermissionsV1Beta1Permissions } from '@injectivelabs/core-proto-ts';
...
export type GrpcPermissionNamespace = InjectivePermissionsV1Beta1Permissions.Namespace;
export type GrpcPermissionRoleIDs = InjectivePermissionsV1Beta1Permissions.RoleIDs;
export type GrpcPermissionsNamespace = InjectivePermissionsV1Beta1Permissions.Namespace;
export type GrpcPermissionRoleActors = InjectivePermissionsV1Beta1Permissions.RoleActors;
export type GrpcPermissionActorRoles = InjectivePermissionsV1Beta1Permissions.ActorRoles;
export type GrpcPermissionRoleManager = InjectivePermissionsV1Beta1Permissions.RoleManager;
export type GrpcPermissionPolicyStatus = InjectivePermissionsV1Beta1Permissions.PolicyStatus;
export type GrpcPermissionAddressVoucher = InjectivePermissionsV1Beta1Permissions.AddressVoucher;
...
export declare const PermissionActionMap: typeof InjectivePermissionsV1Beta1Permissions.Action;
