...
const exchange_js_1 = require("@injectivelabs/core-proto-ts/cjs/injective/exchange/v1beta1/exchange.js");
/**
    ...
    static moduleParamsResponseToParams(response) {
        ...
        return {
            ...
            binaryOptionsMarketInstantListingFee: params.binaryOptionsMarketInstantListingFee
                ...
                : undefined,
            atomicMarketOrderAccessLevel: exchange_js_1.AtomicMarketOrderAccessLevel[params.atomicMarketOrderAccessLevel],
