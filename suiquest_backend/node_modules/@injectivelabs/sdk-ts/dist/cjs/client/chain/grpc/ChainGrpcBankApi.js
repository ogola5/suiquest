...
class ChainGrpcBankApi extends BaseGrpcConsumer_js_1.default {
    module = index_js_2.ChainModule.Bank;
    client;
    ...
    async fetchModuleParams() {
        ...
        try {
            ...
            return index_js_1.ChainGrpcBankTransformer.moduleParamsResponseToModuleParams(response);
        }
        catch (e) {
    ...
    async fetchBalance({ accountAddress, denom, }) {
        ...
        try {
            ...
            return index_js_1.ChainGrpcBankTransformer.balanceResponseToBalance(response);
        }
        catch (e) {
            if (e instanceof core_proto_ts_1.CosmosBankV1Beta1Query.GrpcWebError) {
                throw new exceptions_1.GrpcUnaryRequestException(new Error(e.toString()), {
    ...
    async fetchBalances(address, pagination) {
        ...
        try {
            ...
            return index_js_1.ChainGrpcBankTransformer.balancesResponseToBalances(response);
        }
        catch (e) {
            if (e instanceof core_proto_ts_1.CosmosBankV1Beta1Query.GrpcWebError) {
                throw new exceptions_1.GrpcUnaryRequestException(new Error(e.toString()), {
    ...
    async fetchTotalSupply(pagination) {
        ...
        try {
            ...
            return index_js_1.ChainGrpcBankTransformer.totalSupplyResponseToTotalSupply(response);
        }
        catch (e) {
            if (e instanceof core_proto_ts_1.CosmosBankV1Beta1Query.GrpcWebError) {
                throw new exceptions_1.GrpcUnaryRequestException(new Error(e.toString()), {
    ...
    async fetchDenomsMetadata(pagination) {
        ...
        try {
            ...
            return index_js_1.ChainGrpcBankTransformer.denomsMetadataResponseToDenomsMetadata(response);
        }
        catch (e) {
            if (e instanceof core_proto_ts_1.CosmosBankV1Beta1Query.GrpcWebError) {
                throw new exceptions_1.GrpcUnaryRequestException(new Error(e.toString()), {
    ...
    async fetchDenomMetadata(denom) {
        ...
        try {
            ...
            return index_js_1.ChainGrpcBankTransformer.metadataToMetadata(response.metadata);
        }
        catch (e) {
            if (e instanceof core_proto_ts_1.CosmosBankV1Beta1Query.GrpcWebError) {
                throw new exceptions_1.GrpcUnaryRequestException(new Error(e.toString()), {
    ...
    async fetchDenomOwners(denom, pagination) {
        ...
        try {
            ...
            return index_js_1.ChainGrpcBankTransformer.denomOwnersResponseToDenomOwners(response);
        }
        catch (e) {
            if (e instanceof core_proto_ts_1.CosmosBankV1Beta1Query.GrpcWebError) {
                throw new exceptions_1.GrpcUnaryRequestException(new Error(e.toString()), {
