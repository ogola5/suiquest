...
class IndexerGrpcInsuranceFundApi extends BaseIndexerGrpcConsumer_js_1.default {
    module = index_js_2.IndexerModule.InsuranceFund;
    client;
    ...
    async fetchRedemptions({ denom, address, status, }) {
        ...
        try {
            ...
            return index_js_1.IndexerGrpcInsuranceFundTransformer.redemptionsResponseToRedemptions(response);
        }
        catch (e) {
    ...
    async fetchInsuranceFunds() {
        ...
        try {
            ...
            return index_js_1.IndexerGrpcInsuranceFundTransformer.insuranceFundsResponseToInsuranceFunds(response);
        }
        catch (e) {
            if (e instanceof indexer_proto_ts_1.InjectiveInsuranceRpc.GrpcWebError) {
                throw new exceptions_1.GrpcUnaryRequestException(new Error(e.toString()), {
