...
class IndexerGrpcAccountPortfolioTransformer {
    static accountPortfolioResponseToAccountPortfolio(response, address) {
        ...
        return {
            ...
            bankBalancesList: bankBalancesList.map(IndexerCommonTransformer_js_1.IndexerCommonTransformer.grpcCoinToCoin),
    ...
    static grpcPositionWithUPNLToPositionWithUPNL(positionsWithUPNL) {
        ...
        return {
            position: grpcPosition
                ? IndexerGrpcDerivativeTransformer_js_1.IndexerGrpcDerivativeTransformer.grpcPositionToPosition(grpcPosition)
                : undefined,
