...
class IndexerGrpcReferralApi extends BaseIndexerGrpcConsumer_js_1.default {
    ...
    async fetchReferrerDetails(address) {
        ...
        try {
            const response = await this.retry(() => this.client.GetReferrerDetails(request));
    ...
    async fetchInviteeDetails(address) {
        ...
        try {
            const response = await this.retry(() => this.client.GetInviteeDetails(request));
    ...
    async fetchReferrerByCode(code) {
        ...
        try {
            const response = await this.retry(() => this.client.GetReferrerByCode(request));
...
//# sourceMappingURL=IndexerGrpcReferralApi.js.map