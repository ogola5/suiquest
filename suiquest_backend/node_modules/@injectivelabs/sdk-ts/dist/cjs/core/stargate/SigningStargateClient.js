...
const tx_js_1 = require("cosmjs-types/cosmos/distribution/v1beta1/tx.js");
const tx_js_2 = require("cosmjs-types/cosmos/staking/v1beta1/tx.js");
const signing_js_1 = require("cosmjs-types/cosmos/tx/signing/v1beta1/signing.js");
const tx_js_3 = require("cosmjs-types/cosmos/tx/v1beta1/tx.js");
const tx_js_4 = require("cosmjs-types/ibc/applications/transfer/v1/tx.js");
...
function createDefaultAminoConverters() {
    return {
        ...
        ...(0, stargate_3.createStakingAminoConverters)(),
        ...(0, stargate_3.createIbcAminoConverters)(),
        ...(0, stargate_3.createFeegrantAminoConverters)(),
        ...(0, stargate_3.createVestingAminoConverters)(),
    };
}
class SigningStargateClient extends StargateClient_js_1.StargateClient {
    ...
    async delegateTokens(delegatorAddress, validatorAddress, amount, fee, memo = '') {
        const delegateMsg = {
            ...
            value: tx_js_2.MsgDelegate.fromPartial({
    ...
    async undelegateTokens(delegatorAddress, validatorAddress, amount, fee, memo = '') {
        const undelegateMsg = {
            ...
            value: tx_js_2.MsgUndelegate.fromPartial({
                delegatorAddress: delegatorAddress,
                validatorAddress: validatorAddress,
                amount: amount,
            }),
    ...
    async withdrawRewards(delegatorAddress, validatorAddress, fee, memo = '') {
        const withdrawMsg = {
            ...
            value: tx_js_1.MsgWithdrawDelegatorReward.fromPartial({
                delegatorAddress: delegatorAddress,
                validatorAddress: validatorAddress,
            }),
        };
    ...
    timeoutTimestamp, fee, memo = '') {
        ...
        const transferMsg = {
            ...
            value: tx_js_4.MsgTransfer.fromPartial({
    ...
    async signAndBroadcast(signerAddress, messages, fee, memo = '') {
        ...
        const txBytes = tx_js_3.TxRaw.encode(txRaw).finish();
    ...
    async signAmino(signerAddress, messages, fee, memo, { accountNumber, sequence, chainId }) {
        ...
        return tx_js_3.TxRaw.fromPartial({
