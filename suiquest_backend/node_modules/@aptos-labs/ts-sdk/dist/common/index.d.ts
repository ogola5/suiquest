...
interface Aptos extends Account$1, ANS, Coin, DigitalAsset, Event, Experimental, Faucet, FungibleAsset, General, Keyless, Staking, Table, AptosObject, Omit<Transaction, "build" | "simulate" | "submit" | "batch"> {
}
